                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <h1 className={styles.chatEmptyStateTitle}>Chat with your sources</h1>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Type a new question (e.g. do the sources mention protests or demonstrations?)"
                            disabled={isLoading}
