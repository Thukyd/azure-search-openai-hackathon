...
class ChatReadRetrieveReadApproach(ChatApproach):
    ...
    async def run_until_final_call(
                ...
                "function": {
                    ...
                    "parameters": {
                        ...
                        "properties": {
                            "search_query": {
                                "type": "string",
                                "description": "Query string to retrieve documents from azure search eg: 'Events in Galicia'",
                            }
                        },
        ...
        chat_coroutine = self.openai_client.chat.completions.create(
            ...
            model=self.chatgpt_deployment if self.chatgpt_deployment else self.chatgpt_model,
            messages=messages,
            temperature=overrides.get("temperature") or 0.3, ## NOTE: Changed from 0.7 to 0.3
